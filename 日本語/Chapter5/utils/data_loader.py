"""推定・simulation で共通に使うデータ読込の入口。"""

"""
共通のデータ読み込み処理をまとめたモジュール
"""
...
class SimulationDataBundle:
    """
    Forward simulation や推定で使うデータのセット
    """
...
def load_simulation_data(config) -> SimulationDataBundle:
    """
    main.py と counterfactual.py で共通しているデータ加工処理をまとめた関数
    """
    transition_model = TransitionModel(
